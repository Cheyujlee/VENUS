...
def main():
    ...
    parser.add_argument('-r2', '--fq2', required = False, metavar = 'read2.fastq', type = str, default = '', help = 'Read 2 of the paired end bulk seq OR Barcode read of single-cell seq')
